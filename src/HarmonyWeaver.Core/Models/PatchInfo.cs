...
namespace HarmonyWeaver.Core.Models
{
    ...
    public class PatchInfo
    {
        ...
        /// <summary>
        /// The original HarmonyPatch attribute that defined this patch
        /// </summary>
        public HarmonyPatchAttribute PatchAttribute { get; set; }

        public PatchInfo(TypeDefinition targetType, MethodDefinition targetMethod, HarmonyPatchAttribute patchAttribute)
        {
